...
if [ "$is_arm64_guest" -eq 1 ]; then
    all_tests="$all_tests atomics64 arm64_regress vector_smoke smc_stale_block stlr_ldar_publish ptrace_singlestep ands_bcond_fusion"
fi
if [ "$is_riscv64_guest" -eq 1 ]; then
