...
<!-- LEADERBOARD:START -->
*21 of 47 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16, vLLM/TRT-LLM = claw1, Gemini API = Google cloud.*
...
| `qwq-32b` | 18.0 GB | Q6_K | GGUF | 2025-03 | 13/23 · 15✓ (incomplete) | — |
...
| `google/gemma-4-12b-qat` | 7.15 GB | Q4_0 | GGUF | 2026-06 | 2/9 · 2✓ (incomplete) | — |
