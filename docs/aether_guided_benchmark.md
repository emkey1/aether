...
<!-- LEADERBOARD:START -->
*30 of 47 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16, vLLM/TRT-LLM = claw1, Gemini API = Google cloud.*
...
| `qwen3-vl-30b-a3b-thinking-mlx` | 33.53 GB | 8bit | MLX | 2026-04 | 12/30 · 19✓ | 0/25 · 0✓ (incomplete) |
...
| `google/gemma-4-12b-qat` | 7.15 GB | Q4_0 | GGUF | 2026-06 | 1/29 · 1✓ (incomplete) | — |
...
| `qwen3.5-4b-mlx` | 5.16 GB | 8bit | MLX | 2026-02 | 12/30 · 13✓ | 0/30 · 0✓ |
| `deepseek-r1-distill-qwen-7b` | 4.68 GB | Q4_K_M | GGUF | 2025-01 | 1/30 · 1✓ | 0/30 · 0✓ |
