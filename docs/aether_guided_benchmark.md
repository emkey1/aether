...
| `google/gemma-4-31b` | 33.8 GB | 8bit | MLX | 2026-04 | 29/30 · 29✓ | 20/21 · 20✓ (incomplete) |
...
| `google/gemma-4-12b-qat` | 7.15 GB | Q4_0 | GGUF | 2026-06 | 1/3 · 1✓ (incomplete) | — |
...
| `qwen3:4b` | 2.5 GB | Q4_K_M | Ollama | 2025-04 | 20/23 · 20✓ (incomplete) | — |
...
*19 models scored on the large data set (`tasks_hard.json`, 8 hard tasks). exact/8 · ✓ = compiled & ran. Cloud + claw1 first; locals to follow.*
