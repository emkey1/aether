...
<!-- LEADERBOARD:START -->
*32 of 47 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16, vLLM/TRT-LLM = claw1, Gemini API = Google cloud.*
...
| `nvidia/nemotron-3-nano` | 33.58 GB | 8bit | MLX | 2025-12 | 10/30 · 13✓ | 13/26 · 14✓ (incomplete) |
...
| `GLM-5` | ? | — | GGUF | ? | 30/30 · 30✓ | 29/29 · 29✓ (incomplete) |
...
| `qwen3.5-4b-mlx` | 5.16 GB | 8bit | MLX | 2026-02 | 1/3 · 1✓ (incomplete) | — |
