...
<!-- LEADERBOARD:START -->
*17 of 47 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16, vLLM/TRT-LLM = claw1, Gemini API = Google cloud.*
...
|---|---|---|---|---|---|---|
| `gemini-3.1-pro-preview` | — | none | Gemini API | 2026-04 | 20/20 · 20✓ (incomplete) | — |
| `gemini-3-flash-preview` | — | none | Gemini API | 2026-04 | 9/9 · 9✓ (incomplete) | — |
...
| `qwen3.5-9b-mlx` | 10.45 GB | 8bit | MLX | 2026-02 | 20/26 · 21✓ (incomplete) | — |
...
| `google/gemma-4-12b-qat` | 7.15 GB | Q4_0 | GGUF | 2026-06 | 1/5 · 1✓ (incomplete) | — |
