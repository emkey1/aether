...
<!-- LEADERBOARD:START -->
*14 of 47 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16, vLLM/TRT-LLM = vLLM 0.20.2 / TensorRT-LLM (claw1).*
...
| `gemini-2.5-pro` | ? | — | GGUF | ? | 22/22 · 22✓ (incomplete) | — |
| `qwen3.5-9b-mlx` | 10.45 GB | 8bit | MLX | 2026-02 | 17/19 · 17✓ (incomplete) | — |
