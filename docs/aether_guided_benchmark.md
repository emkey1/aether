...
<!-- LEADERBOARD:START -->
*26 of 47 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16, vLLM/TRT-LLM = claw1, Gemini API = Google cloud.*
...
| `bytedance/seed-oss-36b` | 20.35 GB | 4bit | MLX | 2025-08 | 5/30 · 5✓ | 5/30 · 5✓ |
...
| `mistralai/devstral-small-2507` | 13.28 GB | 4bit | MLX | 2025-07 | 7/8 · 7✓ (incomplete) | — |
