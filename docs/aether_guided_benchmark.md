...
<!-- LEADERBOARD:START -->
*35 of 47 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16, vLLM/TRT-LLM = claw1, Gemini API = Google cloud.*
...
| `google/gemma-4-31b` | 33.8 GB | 8bit | MLX | 2026-04 | 5/5 · 5✓ (incomplete) | — |
...
| `qwen3.5-4b-mlx` | 5.16 GB | 8bit | MLX | 2026-02 | 1/6 · 1✓ (incomplete) | — |
