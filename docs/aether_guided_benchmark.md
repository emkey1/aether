...
<!-- LEADERBOARD:START -->
*6 of 49 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16 runtime, vLLM = vLLM 0.20.2 (claw1).*
