...
<!-- LEADERBOARD:START -->
*25 of 47 local models scored so far (the ≥60B set is served separately). exact/30 · ✓ = compiled & ran · released = YYYY-MM · served: MLX/GGUF = LM Studio 0.4.16, vLLM/TRT-LLM = claw1, Gemini API = Google cloud.*
...
| `bytedance/seed-oss-36b` | 20.35 GB | 4bit | MLX | 2025-08 | 5/30 · 5✓ | 5/14 · 5✓ (incomplete) |
...
*8 models scored on the large data set (`tasks_hard.json`, 8 hard tasks). exact/8 · ✓ = compiled & ran. Cloud + claw1 first; locals to follow.*
...
| `deepseek-r1-distill-qwen-14b` | 15.7 GB | Q8_0 | GGUF | 2025-01 | 2/8 · 3✓ | 2/5 · 2✓ (incomplete) |
