...
In our security model, we expect real security bugs to be very rare. It's not completely impossible, e.g. a bug allowing remote code execution without user consent would be a security bug. If you think you found one, please report it via [GitHub Security Advisories](https://github.com/emkey1/ish-AOK/security/advisories/new). We'll work with you to resolve it appropriately.
